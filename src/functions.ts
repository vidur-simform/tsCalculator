...
const btn2nd:HTMLButtonElement = document.getElementById('btn-2nd') as HTMLButtonElement;
const toggle2nd = () => {
...
//log x base y
const logXBaseY:HTMLButtonElement = document.getElementById('log-x-base-y') as HTMLButtonElement;
